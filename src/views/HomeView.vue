  ...
  <div class="container p-2 pb-5">
    <div class="row justify-content-center">
      <div class="col-11">
        ...
        <div class="card overflow-hidden border-0 rounded-0 text-start">
          <img src="../assets/header_image.jpg" alt="homepage_header">

          <div class="card-img-overlay d-flex card-style">
    ...
    <div class="row row-cols-1 row-cols-md-3 m-5 card-deck">
      <div class="col justify-content-center">
        <div class="card h-100">
          <img src="../assets/image_1.jpg" class="card-img-top" alt="image_1">
          <div class="card-body">
